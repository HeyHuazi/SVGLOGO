<!--
  [INPUT]: 依赖 @/data/svgs、types/assets 统一主题解析与 @/data/changelog 更新日期
  [OUTPUT]: 对外提供 HeroSection 首屏组件，展示品牌叙事、统计数据与亮色界面 Logo 流
  [POS]: components 层的新版首页 Hero，被 +page.svelte 消费，不自行解释主题资源结构
    ...
    <div class="flex flex-col items-start gap-12 lg:flex-row lg:gap-8">
      ...
      <div class="min-w-0 flex-1 lg:max-w-[590px]">
        <div class="flex flex-col gap-2.5">
          <span
            class="mb-1 text-base font-medium text-[#06B30C] dark:text-green-500"
          >
            {totalCount}+ 矢量标志
          </span>
          <h1
            class="text-[60px] font-bold leading-none tracking-tight text-black dark:text-white"
          >
            国内矢量标志收录
          </h1>
          <p
            class="mt-2 max-w-[590px] text-base leading-relaxed text-black/50 dark:text-neutral-400"
          >
            专注收录国内矢量 LOGO，免费在线下载矢量 LOGO
            素材，为设计师和开发者提供高质量的品牌标识资源。
          </p>
        </div>
          ...
          <div>
            ...
            <a
              ...
              on:click|preventDefault={() => {
                window.location.href = "/about#更新日志";
              }}
              class="group/date mt-3 inline-flex items-center gap-1.5 text-base text-black transition-colors duration-150 hover:text-[#06B30C] dark:text-white dark:hover:text-green-500"
            >
              ...
              <svg
                ...
                height="18"
                viewBox="0 0 18 18"
                class="transition-transform duration-150 group-hover/date:translate-x-0.5"
              >
                <polyline
      ...
      <div class="hidden w-[585px] flex-shrink-0 lg:block">
        <div class="relative h-[271px] overflow-hidden rounded-xl">
          <!-- Row 1: scroll right (slow) -->
          <div
            class="animate-carousel-right absolute flex gap-3"
            style="top: 0; animation-duration: 40s;"
          >
            {#each [...row1Logos, ...row1Logos] as svg}
              <div
                class="flex h-20 w-20 flex-shrink-0 items-center justify-center rounded-xl border border-neutral-100 bg-white shadow-[0_1px_3px_rgba(0,0,0,0.04)] dark:border-neutral-700 dark:bg-neutral-800"
              >
                <img
                  src={getImagePath(svg.route)}
                  alt={svg.title}
          ...
          <div
            class="animate-carousel-left absolute flex gap-3"
            style="top: 92px; animation-duration: 30s;"
          >
          ...
          <!-- Row 3: scroll right (medium) -->
          <div
            class="animate-carousel-right absolute flex gap-3"
            style="top: 184px; animation-duration: 35s;"
          >
          ...
          <!-- Left gradient fade -->
          <div
            class="pointer-events-none absolute left-0 top-0 z-10 h-full w-[30px] bg-gradient-to-r from-[#FAFAFA] to-transparent dark:from-neutral-900"
          ></div>
          <!-- Right gradient fade -->
          <div
            class="pointer-events-none absolute right-0 top-0 z-10 h-full w-[30px] bg-gradient-to-l from-[#FAFAFA] to-transparent dark:from-neutral-900"
          ></div>
        </div>
      </div>
    </div>
