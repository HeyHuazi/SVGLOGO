...
>
  ...
  <div class="flex flex-col items-center gap-0.5 w-full pt-2 pb-1.5 px-3">
    <div class="w-full overflow-hidden relative">
      <p
        class="text-[13px] font-medium text-[#171717] dark:text-white text-center truncate leading-[150%]"
        title={svgInfo.title}
      >
        {svgInfo.title}
      </p>
  ...
  <!-- Action Buttons -->
  <div class="flex items-center gap-1 justify-center w-full py-1.5 px-2 rounded-lg bg-neutral-50/50 dark:bg-neutral-800/30">
    {#if isInFigma}
      <button
        title="插入到 Figma"
        on:click={() => {
        ...
        class="flex items-center justify-center rounded-md min-w-[36px] min-h-[36px] p-2 text-[#737373] dark:text-[#737373] duration-100 hover:bg-neutral-200 dark:hover:bg-neutral-700/40"
        aria-label="插入到 Figma"
      >
